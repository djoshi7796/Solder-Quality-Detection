...
#Loss curves
df = pd.read_csv("../../results/results"+'_final'+".csv",header=None, names=["acc", "loss", "val_acc","val_loss"])
...
<html>
	...
	<body>
	    ...
	    <h2> RESULTS </h2>
	        ...
	        <h2> PREDICTIONS </h2>
                    <h3> True positives </h3>'''+"<img src='data:image/png;base64,{}'>".format(plot_predictions('positives.txt').decode("utf-8"))+'''
                    <h3> False negatives </h3>'''+"<img src='data:image/png;base64,{}'>".format(plot_predictions('negatives.txt').decode("utf-8"))+'''
        </body>
</html>'''
f = open('report_actual.html','w')
f.write(html_string)
f.close()
